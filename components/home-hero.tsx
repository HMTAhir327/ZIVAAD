  ...
  return (
    <section className="relative isolate flex min-h-[72vh] w-full items-center overflow-hidden border-b border-stone-200 bg-black sm:min-h-[84vh] lg:min-h-[95vh]">
      ...
      >
        ...
        <div className="mt-8 flex flex-col justify-center gap-2 sm:mt-10 sm:flex-row sm:gap-3">
          <Link
            href={hero.primary_cta_href}
            className="inline-flex w-full items-center justify-center bg-white px-8 py-3 text-[11px] uppercase tracking-luxury text-stone-950 transition-colors hover:bg-stone-100 sm:w-auto sm:text-xs"
          >
            {hero.primary_cta_label}
          </Link>
          <Link
            href={hero.secondary_cta_href}
            className="inline-flex w-full items-center justify-center border border-white px-8 py-3 text-[11px] uppercase tracking-luxury text-white transition-colors hover:bg-white hover:text-stone-950 sm:w-auto sm:text-xs"
          >
