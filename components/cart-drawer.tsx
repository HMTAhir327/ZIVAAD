                ...
                <div className="space-y-4 px-4 py-4 pb-[calc(1rem+env(safe-area-inset-bottom))] sm:px-5 sm:py-5">
                  ...
                  <div className="space-y-4 border-t border-stone-200 pt-4">
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2 bg-[#25D366] px-5 py-3 text-[11px] uppercase tracking-luxury text-white transition-opacity duration-300 disabled:cursor-not-allowed disabled:opacity-40"
                    >
