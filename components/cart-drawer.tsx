      ...
      {isCartOpen ? (
        <>
          ...
          <motion.aside
            ...
            className="fixed right-0 top-0 z-[109] h-full w-full max-w-[420px] border-l border-stone-200 bg-white sm:max-w-md"
          >
            <div className="flex h-full flex-col">
              <div className="border-b border-stone-200 px-4 py-3 sm:px-5">
                <p className="text-[10px] uppercase tracking-luxury text-stone-500">Free Shipping Progress</p>
              ...
              <div className="flex items-center justify-between border-b border-stone-200 px-4 py-4 sm:px-5">
                <h3 className="font-serif text-2xl text-stone-950 sm:text-3xl">Your Bag</h3>
                <button
                  type="button"
                  onClick={closeCart}
              ...
              <div className="flex-1 space-y-4 overflow-y-auto px-4 py-4 sm:px-5 sm:py-5">
                {items.length === 0 ? (
                  ...
                  items.map((item) => {
                    ...
                    return (
                    <article key={lineId} className="flex gap-3 border-b border-stone-100 pb-4">
                ...
                <div className="space-y-3 border border-stone-200 p-4">
                  <p className="text-[10px] uppercase tracking-luxury text-stone-500">Checkout Details</p>
                  <input
                    type="text"
                    placeholder="Name"
                    value={customer.name}
              ...
              <div className="space-y-4 border-t border-stone-200 bg-white px-4 py-4 pb-[calc(1rem+env(safe-area-inset-bottom))] sm:px-5">
